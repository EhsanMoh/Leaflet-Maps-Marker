...
if (isset($_GET['layer'])) {
	...
	$lmm_out .= '<![endif]-->'.PHP_EOL;
	$lmm_out .= '<style type="text/css" id="leafletmapsmarker-image-css-override">.leaflet-popup-content img { ' . $lmm_options['defaults_marker_popups_image_css'] . ' }</style>'.PHP_EOL;
